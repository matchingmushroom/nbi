...
export const BADGES = [
  ...
  { id: 'final_boss', name: 'Final Boss', icon: 'military_tech', desc: 'Complete the Final Mock Pre-Test' },
  ...
  { id: 'champion', name: 'Champion', icon: 'emoji_events', desc: 'Score 100% on the Final Mock Pre-Test' },
